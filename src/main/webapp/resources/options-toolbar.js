(function() {
    ...
    var href = 'resources/packages/ext-theme-'+theme+'/build/resources/ext-theme-'+theme+'-all.css';  
    ...
    var hrefscript='resources/packages/ext-theme-'+theme+'/build/ext-theme-'+theme+'.js';
    var script = Ext.fly('themescript');  
    ...
    script.set({src:Ext.String.format(hrefscript, theme)});  
